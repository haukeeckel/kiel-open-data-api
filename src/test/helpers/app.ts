...
import { statisticsSeedRows } from '../fixtures/statisticsSeed.js';

import { setTestEnv } from './env.js';
import { buildStatisticsInsert } from './statisticsSeedBuilder.js';
...
export async function seedStatistics(db: DuckDBInstance) {
  ...
  try {
    ...
    const { sql, params } = buildStatisticsInsert(statisticsSeedRows);
